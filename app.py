...
rf_class = rf_classifier.predict(
    latest
)[0]

gb_class = gb_classifier.predict(
    latest
)[0]
...
rf_price = rf_regressor.predict(
    latest
)[0]

gb_price = gb_regressor.predict(
    latest
)[0]
